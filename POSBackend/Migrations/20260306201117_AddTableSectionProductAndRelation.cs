...
{
    /// <inheritdoc />
    public partial class AddTableSectionProductAndRelation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalTranfer = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockMininum = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleDatils", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleDatils_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleDatils_Sales_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleDatils_ProductId",
                table: "SaleDatils",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleDatils_SaleId",
                table: "SaleDatils",
                column: "SaleId");
